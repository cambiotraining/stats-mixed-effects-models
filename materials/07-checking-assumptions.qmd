...
::: {.panel-tabset group="language"}
## R
```{r check_model_standard_diagnostics}
...
::: {.panel-tabset group="language"}
## R
```{r check_model_posterior_predictive}
...
![They look like this - quite pretty!](images/arabidopsis.webp){width=40% fig-alt="Close-up of an arabidopsis plant, with delicate white flowers"}
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_diagnostics}

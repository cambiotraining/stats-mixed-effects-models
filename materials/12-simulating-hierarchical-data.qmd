...
![Design for `dragons` dataset](images/full_dragons_design.png)
...
## R
```{r set_seed_for_reproducibility}
set.seed(20)
```
:::
...
::: {.panel-tabset group="language"}
## R
```{r create_variance_covariance_matrix}
...
::: {.panel-tabset group="language"}
## R
```{r simulate_mountain_random_effects}
...
::: {.panel-tabset group="language"}
## R
```{r simulate_cave_researcher_random_effects}
...
::: {.panel-tabset group="language"}
## R
```{r scales_varying_at_level3_optional}
...
::: {.panel-tabset group="language"}
## R
```{r scales_varying_at_level1_optional}
...
::: {.panel-tabset group="language"}
## R
```{r explore_model_matrix, eval=FALSE}
...
::: {.panel-tabset group="language"}
## R
```{r simulate_intelligence_responses}
...
::: {.panel-tabset group="language"}
## R
```{r check_simulated_model_assumptions}
...
::: {.panel-tabset group="language"}
## R
```{r plot_dragon_model_all_observations}
...
::: {.panel-tabset group="language"}
## R
```{r plot_dragon_model_by_researcher}
ggplot(augment(lme_test), aes(y = intelligence, x = wingspan, 
                              colour = mountain, linetype = scales)) +
...
::: {.panel-tabset group="language"}
## R
```{r plot_dragon_model_by_mountain}
ggplot(augment(lme_test), aes(y = intelligence, x = wingspan, 

...
```{r load_worked_answer_libraries}
#| eval: false
...
```{r fit_solutions_intercepts_model}
...
```{r attempt_solutions_slopes_model}
...
## R
```{r fit_dragons_no_scales_question1}
...
::: {.panel-tabset group="language"}
## R
```{r fit_dragons_no_scales_question2}
dragons <- read_csv("data/dragons.csv")
...
::: {.panel-tabset group="language"}
## R
```{r test_irrigation_fixed_effects_interaction}
...
```{r test_irrigation_fixed_effects_variety}
...
```{r test_irrigation_fixed_effects_irrigation}
...
::: {.panel-tabset group="language"}
## R
```{r test_irrigation_random_effect}
...
::: {.panel-tabset group="language"}
## R
```{r test_arabidopsis_fixed_effects}
library(lmerTest)
...
::: {.panel-tabset group="language"}
## R
```{r fit_arabidopsis_reduced_fixed}
...
::: {.panel-tabset group="language"}
## R
```{r summarize_arabidopsis_original}
...
::: {.panel-tabset group="language"}
## R
```{r fit_arabidopsis_reduced_random}
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_reduced_diagnostics}
...
::: {.panel-tabset group="language"}
## R
```{r histogram_arabidopsis_fruits}
...
::: {.panel-tabset group="language"}
## R
```{r attempt_cake_random_slopes_categorical}
#| eval: false
...
::: {.panel-tabset group="language"}
## R
```{r attempt_cake_random_slopes_continuous}
#| eval: false
...
::: {.panel-tabset group="language"}
## R
```{r compare_cake_temperature_vs_temp}
...
::: {.panel-tabset group="language"}
## R
```{r fit_cake_temperature_as_random}

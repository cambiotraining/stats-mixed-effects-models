...
![Branch and item as crossed effects](images/fastfood_design.png){width=40%}
...
![The Stroop task](images/stroop.png){width=70%}
...
![Latin square design of abrasion experiment](images/latin_square.png){width=30%}
...
::: {.panel-tabset group="language"}
## R
```{r fit_penicillin_crossed_model}
...
::: {.panel-tabset group="language"}
## R
```{r plot_penicillin_random_intercepts}
...
::: {.panel-tabset group="language"}
## R
```{r load_politeness_data, message=FALSE}
...
![Experimental design for voice pitch experiment #1](images/politeness_design.png){width=60%}

![Experimental design for voice pitch experiment #2](images/politeness_design2.png){width=60%}
...
::: {.panel-tabset group="language"}
## R
```{r fit_politeness_reduced_model}
...
::: {.panel-tabset group="language"}
## R
```{r check_politeness_assumptions}

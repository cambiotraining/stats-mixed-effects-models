...
Using the same code as you've practised above, perform model comparison to draw conclusions about which factors should be considered when maximising crop yield.

To give you a bit of a challenge, there's no worked answer for this exercise, but feel free to call over a trainer or chat to a neighbour if you want to compare results!

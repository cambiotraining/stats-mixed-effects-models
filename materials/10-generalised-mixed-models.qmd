...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_lmm_diagnostics}
...
::: {.panel-tabset group="language"}
## R
```{r fit_arabidopsis_glmm_poisson}
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_glmm_poisson_diagnostics}
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_glmm_poisson_overdispersion}
check_model(glmm_arabidopsis, residual_type = "normal",
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_glmm_negbin_diagnostics}
...
::: {.panel-tabset group="language"}
## R
```{r plot_arabidopsis_fruit_histogram}
...
::: {.panel-tabset group="language"}
## R
```{r fit_arabidopsis_glmm_zero_inflated_poisson}
...
::: {.panel-tabset group="language"}
## R
```{r check_arabidopsis_glmm_zero_inflated_poisson}
...
::: {.panel-tabset group="language"}
## R
```{r fit_arabidopsis_glmm_zero_inflated_negbin}

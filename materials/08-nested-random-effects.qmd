...
![Experimental design](images/nested-patients1.png){width=70%}
...
## R
```{r load_health_data, message=FALSE}
...
![Scenario 1: predictor varies at level 1 (between patients, within doctors)](images/nested-patients2.png){width=70%}
...
::: {.panel-tabset group="language"}
## R
```{r load_health2_data, message=FALSE}
...
![Scenario 2: predictor varies at level 2 (between doctors, within hospitals)](images/nested-patients3.png){width=70%}
...
![Scenario 3: predictor varies at level 3 (between hospitals)](images/nested-patients4.png){width=70%}
...
![Pastes dataset design](images/pastes_design.png){width=70%}
...
![Experimental design for Cook's cakes](images/cake_design.png){width=70%}
...
::: {.panel-tabset group="language"}
## R
```{r load_parallel_data, message=FALSE}
...
![An example of a stained slice from cerebellar cortex](images/cerebellum_histology.jpg){width=40%}
...
![Experimental design](images/neurohist_design.png){width=70%}
...
::: {.panel-tabset group="language"}
## R
```{r fit_parallel_intercepts_model}

...
## R
```{r load_planking_data, message=FALSE}
...
::: {.panel-tabset group="language"}
## R
```{r simulate_expected_ranefs_plot, echo=FALSE}
set.seed(13)
...
::: {.panel-tabset group="language"}
## R
```{r expected_ranefs_plot_code, eval=FALSE}
library(patchwork)
...
::: {.panel-tabset group="language"}
## R
```{r plot_actual_ranefs, echo=FALSE}
...
::: {.panel-tabset group="language"}
## R
```{r summarize_plank_model_correlation}
summary(lme_plank)
```
:::
...
::: {.panel-tabset group="language"}
## R
```{r plot_ranefs_no_correlation, echo=FALSE}
